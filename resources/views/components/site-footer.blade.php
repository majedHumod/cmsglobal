    ...
    <div class="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div class="col-span-1 md:col-span-1">
                <div class="flex items-center">
                    @if(isset($siteSettings) && isset($siteSettings['general']['site_logo']) && $siteSettings['general']['site_logo'])
                        <img class="h-10 w-auto" src="{{ Storage::url($siteSettings['general']['site_logo']) }}" alt="{{ $siteSettings['general']['site_name'] }}">
                    @else
                        <span class="text-xl font-bold text-indigo-600">{{ isset($siteSettings) && isset($siteSettings['general']['site_name']) ? $siteSettings['general']['site_name'] : config('app.name') }}</span>
                    @endif
                </div>
                <p class="mt-4 text-gray-500 text-sm">
                    {{ isset($siteSettings) && isset($siteSettings['general']['site_description']) ? $siteSettings['general']['site_description'] : 'نظام إدارة محتوى متكامل يوفر حلول متقدمة لإدارة المحتوى الرقمي.' }}
                </p>
            </div>
            ...
            <div class="col-span-1">
                ...
                <ul class="mt-4 space-y-4">
                    @if(isset($siteSettings) && isset($siteSettings['contact']['contact_phone']) && $siteSettings['contact']['contact_phone'])
                        <li class="flex">
                    ...
                    @if(isset($siteSettings) && isset($siteSettings['contact']['contact_whatsapp']) && $siteSettings['contact']['contact_whatsapp'])
                        <li class="flex">
                    ...
                    @if(isset($siteSettings) && isset($siteSettings['contact']['contact_email']) && $siteSettings['contact']['contact_email'])
                        <li class="flex">
                            <svg class="flex-shrink-0 h-5 w-5 text-gray-400 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    @if(isset($siteSettings) && isset($siteSettings['contact']['contact_address']) && $siteSettings['contact']['contact_address'])
                        <li class="flex">
                            <svg class="flex-shrink-0 h-5 w-5 text-gray-400 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="col-span-1">
                ...
                <div class="mt-4 space-y-4">
                    @if(isset($siteSettings) && isset($siteSettings['app']['app_android']) && $siteSettings['app']['app_android'])
                    ...
                    @if(isset($siteSettings) && isset($siteSettings['app']['app_ios']) && $siteSettings['app']['app_ios'])
                ...
                <div class="mt-8">
                    ...
                    <div class="mt-4 flex space-x-6">
                        @if(isset($siteSettings) && isset($siteSettings['social']['social_facebook']) && $siteSettings['social']['social_facebook'])
                        ...
                        @if(isset($siteSettings) && isset($siteSettings['social']['social_twitter']) && $siteSettings['social']['social_twitter'])
                        ...
                        @if(isset($siteSettings) && isset($siteSettings['social']['social_instagram']) && $siteSettings['social']['social_instagram'])
                        ...
                        @if(isset($siteSettings) && isset($siteSettings['social']['social_youtube']) && $siteSettings['social']['social_youtube'])
        ...
        <div class="mt-12 border-t border-gray-200 pt-8">
            <p class="text-base text-gray-400 text-center">
                {{ isset($siteSettings) && isset($siteSettings['general']['footer_text']) ? $siteSettings['general']['footer_text'] : '© ' . date('Y') . ' ' . (isset($siteSettings) && isset($siteSettings['general']['site_name']) ? $siteSettings['general']['site_name'] : config('app.name')) . '. جميع الحقوق محفوظة.' }}
            </p>
        </div>
    </div>
</footer>