            ...
            <div class="relative">
                ...
                ">
                    ...
                    @if($testimonials->count() > 2)
                        <button @click="prevSlide()" class="absolute top-1/2 right-4 transform -translate-y-1/2 bg-white rounded-full p-2 shadow-lg hover:shadow-xl transition-shadow z-10">
                            <svg class="w-6 h-6 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path>
                            </svg>
                        </button>
                        
                        <button @click="nextSlide()" class="absolute top-1/2 left-4 transform -translate-y-1/2 bg-white rounded-full p-2 shadow-lg hover:shadow-xl transition-shadow z-10">
                            <svg class="w-6 h-6 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<style>
    ...
    .testimonials-carousel .flex {
        width: {{ $testimonials->count() * 100 }}%;
    }
    
    @media (min-width: 768px) {
        .testimonials-carousel .flex {
            width: {{ $testimonials->count() * 50 }}%;
        }
    }
</style>