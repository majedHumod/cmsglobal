                    ...
                    <form action="{{ route('articles.update', $article) }}" method="POST" enctype="multipart/form-data">
                        ...
                        @if($article->image)
                            <div class="mb-4">
                                ...
                                <img src="{{ Storage::url($article->image) }}" alt="{{ $article->title }}" class="w-48 h-48 object-cover rounded">
                            </div>
                        @endif

                        <div class="mb-4">
                            <label for="image" class="block text-gray-700 text-sm font-bold mb-2">New Image (Optional)</label>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <a href="{{ route('articles.index') }}" class="text-gray-500 hover:text-gray-700">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
