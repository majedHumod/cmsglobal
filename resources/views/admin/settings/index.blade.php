...
<div class="bg-white shadow-md rounded-lg overflow-hidden" dir="rtl">
    <div class="p-6" dir="rtl">
        <div class="mb-6">
            <h2 class="text-lg font-medium text-gray-900 text-right">إعدادات الموقع</h2>
            <p class="mt-1 text-sm text-gray-500 text-right">قم بتخصيص إعدادات موقعك من هنا.</p>
        </div>

        <!-- Tabs -->
        <div class="border-b border-gray-200 mb-6" dir="rtl">
            <ul class="flex flex-wrap -mb-px justify-start" id="settingsTabs" role="tablist" dir="rtl">
        ...
        <!-- Tab Content -->
        <div id="settingsTabContent" dir="rtl">
            <!-- General Settings -->
            <div class="block text-right" id="general" role="tabpanel" aria-labelledby="general-tab">
                        ...
                        <div>
                            ...
                            @if(\App\Models\SiteSetting::get('site_logo'))
                                <div class="mt-2 mb-4 text-right">
                                    ...
                                    <p class="mt-1 text-xs text-gray-500 text-right">الشعار الحالي</p>
                                </div>
                            @endif
                        ...
                        <div>
                            ...
                            @if(\App\Models\SiteSetting::get('site_favicon'))
                                <div class="mt-2 mb-4 text-right">
                                    ...
                                    <p class="mt-1 text-xs text-gray-500 text-right">الأيقونة الحالية</p>
                                </div>
                            @endif
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div class="mt-1 flex rounded-md shadow-sm">
                                ...
                                <input type="text" name="primary_color_text" id="primary_color_text" class="mr-2 flex-1 rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" value="{{ old('primary_color', \App\Models\SiteSetting::get('primary_color', '#6366f1')) }}" readonly>
                            </div>
                        ...
                        <div>
                            ...
                            <div class="mt-1 flex rounded-md shadow-sm">
                                ...
                                <input type="text" name="secondary_color_text" id="secondary_color_text" class="mr-2 flex-1 rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" value="{{ old('secondary_color', \App\Models\SiteSetting::get('secondary_color', '#10b981')) }}" readonly>
                            </div>
            ...
            <!-- Contact Settings -->
            <div class="hidden text-right" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                <form action="{{ route('admin.settings.update-contact') }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div class="mt-1 flex rounded-md shadow-sm">
                                <input type="text" name="contact_telegram" id="contact_telegram" class="flex-1 min-w-0 block w-full px-3 py-2 rounded-none rounded-r-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500" value="{{ old('contact_telegram', \App\Models\SiteSetting::get('contact_telegram')) }}" dir="ltr">
                                <span class="inline-flex items-center px-3 rounded-l-md border border-l-0 border-gray-300 bg-gray-50 text-gray-500 text-sm">@</span>
                            </div>
            ...
            <div class="hidden text-right" id="social" role="tabpanel" aria-labelledby="social-tab">
                <form action="{{ route('admin.settings.update-social') }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div class="mt-1 flex rounded-md shadow-sm">
                                <input type="url" name="social_facebook" id="social_facebook" class="flex-1 min-w-0 block w-full px-3 py-2 rounded-none rounded-r-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500" value="{{ old('social_facebook', \App\Models\SiteSetting::get('social_facebook')) }}" dir="ltr">
                                <span class="inline-flex items-center px-3 rounded-l-md border border-l-0 border-gray-300 bg-gray-50 text-gray-500 text-sm">
                        ...
                        <div>
                            ...
                            <div class="mt-1 flex rounded-md shadow-sm">
                                ...
                                <input type="url" name="social_twitter" id="social_twitter" class="flex-1 min-w-0 block w-full px-3 py-2 rounded-none rounded-r-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500" value="{{ old('social_twitter', \App\Models\SiteSetting::get('social_twitter')) }}" dir="ltr">
                            </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div class="mt-1 flex rounded-md shadow-sm">
                                ...
                                <input type="url" name="social_instagram" id="social_instagram" class="flex-1 min-w-0 block w-full px-3 py-2 rounded-none rounded-r-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500" value="{{ old('social_instagram', \App\Models\SiteSetting::get('social_instagram')) }}" dir="ltr">
                            </div>
                        ...
                        <div>
                            ...
                            <div class="mt-1 flex rounded-md shadow-sm">
                                ...
                                <input type="url" name="social_linkedin" id="social_linkedin" class="flex-1 min-w-0 block w-full px-3 py-2 rounded-none rounded-r-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500" value="{{ old('social_linkedin', \App\Models\SiteSetting::get('social_linkedin')) }}" dir="ltr">
                            </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div class="mt-1 flex rounded-md shadow-sm">
                                ...
                                <input type="url" name="social_youtube" id="social_youtube" class="flex-1 min-w-0 block w-full px-3 py-2 rounded-none rounded-r-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500" value="{{ old('social_youtube', \App\Models\SiteSetting::get('social_youtube')) }}" dir="ltr">
                            </div>
                    ...
                    <div class="border-t border-gray-200 pt-6 mt-6">
                        <h3 class="text-lg font-medium text-gray-900 mb-4 text-right">روابط التطبيقات</h3>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div class="mt-1 flex rounded-md shadow-sm">
                                    ...
                                    <input type="url" name="app_android" id="app_android" class="flex-1 min-w-0 block w-full px-3 py-2 rounded-none rounded-r-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500" value="{{ old('app_android', \App\Models\SiteSetting::get('app_android')) }}" dir="ltr">
                                </div>
                            ...
                            <div>
                                ...
                                <div class="mt-1 flex rounded-md shadow-sm">
                                    ...
                                    <input type="url" name="app_ios" id="app_ios" class="flex-1 min-w-0 block w-full px-3 py-2 rounded-none rounded-r-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500" value="{{ old('app_ios', \App\Models\SiteSetting::get('app_ios')) }}" dir="ltr">
                                </div>
            ...
            <!-- App Settings -->
            <div class="hidden text-right" id="app" role="tabpanel" aria-labelledby="app-tab">
                        ...
                        <div>
                            <div class="flex items-start">
                                ...
                                <div class="mr-3 text-sm text-right">
                                    <label for="maintenance_mode" class="font-medium text-gray-700 text-right">وضع الصيانة</label>
                                    <p class="text-gray-500 text-right">تفعيل وضع الصيانة لإغلاق الموقع مؤقتاً.</p>
                                </div>
                            </div>
                        </div>
