...
@section('header', 'تعديل الصفحة الرئيسية: ' . $landingPage->title)
        ...
        <form action="{{ route('admin.landing-pages.update', $landingPage) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="border-b border-gray-200 pb-6">
                ...
                <div class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="title" id="title" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" value="{{ old('title', $landingPage->title) }}" required>
                        @error('title')
                    ...
                    <div>
                        ...
                        <input type="text" name="subtitle" id="subtitle" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" value="{{ old('subtitle', $landingPage->subtitle) }}">
                        @error('subtitle')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="mt-6">
                    ...
                    <div>
                        ...
                        @if($landingPage->header_image)
                            <div class="mt-2 mb-4">
                                <img src="{{ Storage::url($landingPage->header_image) }}" alt="{{ $landingPage->title }}" class="h-40 w-full object-cover rounded">
                                <p class="mt-1 text-xs text-gray-500">الصورة الحالية</p>
                            </div>
                        @endif
                        <div class="mt-1 flex items-center">
                            <input type="file" name="header_image" id="header_image" class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-indigo-50 file:text-indigo-700 hover:file:bg-indigo-100" accept="image/*">
                        </div>
                        <p class="mt-1 text-sm text-gray-500">يفضل أن تكون الصورة بأبعاد 1920×600 بكسل. اترك هذا الحقل فارغاً للاحتفاظ بالصورة الحالية.</p>
                        @error('header_image')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div class="mt-1 flex rounded-md shadow-sm">
                            <input type="color" name="header_text_color" id="header_text_color" class="h-10 w-10 border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500" value="{{ old('header_text_color', $landingPage->header_text_color) }}">
                            <input type="text" name="header_text_color_text" id="header_text_color_text" class="ml-2 flex-1 rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" value="{{ old('header_text_color', $landingPage->header_text_color) }}" readonly>
                        </div>
            ...
            <div class="border-b border-gray-200 py-6">
                ...
                <div class="mt-6">
                    ...
                    <div class="flex items-start">
                        <div class="flex items-center h-5">
                            <input type="checkbox" name="show_join_button" id="show_join_button" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded" {{ old('show_join_button', $landingPage->show_join_button) ? 'checked' : '' }}>
                        </div>
                ...
                <div class="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="join_button_text" id="join_button_text" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" value="{{ old('join_button_text', $landingPage->join_button_text) }}">
                    ...
                    <div>
                        ...
                        <input type="text" name="join_button_url" id="join_button_url" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" value="{{ old('join_button_url', $landingPage->join_button_url) }}">
                    ...
                    <div>
                        ...
                        <div class="mt-1 flex rounded-md shadow-sm">
                            <input type="color" name="join_button_color" id="join_button_color" class="h-10 w-10 border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500" value="{{ old('join_button_color', $landingPage->join_button_color) }}">
                            <input type="text" name="join_button_color_text" id="join_button_color_text" class="ml-2 flex-1 rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" value="{{ old('join_button_color', $landingPage->join_button_color) }}" readonly>
                        </div>
                ...
                <div class="mt-6">
                    ...
                    <div>
                        ...
                        <div id="editor-container" class="border-l border-r border-b border-gray-300 rounded-b-md">
                            ...
                            <textarea name="content" id="content-textarea" class="hidden w-full min-h-96 p-4 border-0 focus:outline-none focus:ring-2 focus:ring-indigo-500" style="direction: rtl;">{!! old('content', $landingPage->content) !!}</textarea>
                        </div>
            ...
            <div class="border-b border-gray-200 py-6">
                ...
                <div class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="meta_title" id="meta_title" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" value="{{ old('meta_title', $landingPage->meta_title) }}">
                    ...
                    <div>
                        ...
                        <input type="text" name="meta_description" id="meta_description" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" value="{{ old('meta_description', $landingPage->meta_description) }}">
            ...
            <div class="py-6">
                ...
                <div class="mt-6">
                    ...
                    <div class="flex items-start">
                        <div class="flex items-center h-5">
                            <input type="checkbox" name="is_active" id="is_active" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded" {{ old('is_active', $landingPage->is_active) ? 'checked' : '' }}>
                        </div>
                        <div class="ml-3 text-sm">
